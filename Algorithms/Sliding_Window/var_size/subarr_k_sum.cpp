...
// along with the number of times the same sum occurs. We store the data in the form:
...
// to that sum in the hashmap. Further, for every sum encountered, we also determine
// the number of times the sum ksum−k has occurred already, since it will determine the number of times
// a subarray with sum k has occurred up to the current index. We increment
//  by the same amount.
