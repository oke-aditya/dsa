...
// that the child will be content with; and
// each cookie j has a size s[j]. If s[j] >= g[i],
// we can assign the cookie j to the child i,
// and the child i will be content.
// Your goal is to maximize the number
...
// And even though you have 2 cookies, since their size is
// both 1, you could only make the child whose greed
// factor is 1 content.
...
// You have 3 cookies and their sizes are
