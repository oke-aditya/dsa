...
int min_coins_rec(int coins[], int n, int change)
{
    ...
    else
    {
        ...
        return min(min_coins_rec(coins, n-1, change-coins[n-1]) + 1, min_coins_rec(coins, n-1, change));
    }    
}
...
int min_coins_mem(int coins[], int n, int change)
{
    ...
    {
        dp[n][change] = min(min_coins_rec(coins, n-1, change-coins[n-1]) + 1, min_coins_rec(coins, n-1, change));
        return (dp[n][change]);
    }
}
...
int main(int argc, char const *argv[])
{
    ...
    int change = 11; 
    cout << "Minimum coins required is " << min_coins_rec(coins, n, change)<<endl; 
    ...
    cout << "Minimum coins required is " << min_coins_mem(coins, n, change)<<endl; 
    return 0;
}