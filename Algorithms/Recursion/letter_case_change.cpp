...
// Solution: -
// We have 2 choices if the character is letter, it can be converted to upper case or lower case.
// If the character is digit we have no choice, we just take it.
// We just add these to results.
