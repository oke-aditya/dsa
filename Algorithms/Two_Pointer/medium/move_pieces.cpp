...
// space directly to its left, and a piece 'R' can move to the right only if there is a blank space directly to its right.
...
class Solution {
    public:
        bool canChange(string start, string target) {
            // find out non '_' things? 
            // iterate through both and try to see if it's '_' or not
