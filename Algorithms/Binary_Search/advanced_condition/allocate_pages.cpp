...
// assigned to a student is minimum. Input : pages[] = {12, 34, 67, 90}
//         m = 2
// Output : 113
// Explanation:
...
// In this process, if the number of students becomes more than m, then the
// solution is not feasible. Else feasible.
