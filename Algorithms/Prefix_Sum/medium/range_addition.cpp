...
// we add inc to nums[start] and subtract inc from nums[end + 1] (if end + 1 <
// n). This ensures that we mark where the increment starts and where it ends.

// Prefix Sum Calculation: After applying all the operations,
// we iterate through the array and accumulate the values to get the final
// result.
//
