...
// Problem Statement: Given a sorted dictionary of an alien language having N
// words and k starting alphabets of a standard dictionary. Find the order of
// characters in the alien language. Input: N = 5, K = 4 dict =
// {"baa","abcd","abca","cab","cad"} Output: b d a c
