...
// We can use the idea of topological sort here, it will benefit in further questions
// 
// 
...
bool canFinish(int numCourses, vector<vector<int>>& prerequisites) 
{
    ...
    // the trick, if we have traversed fully, then topological sort is indeed size of number of nodes
    return topo.size() == n;
    // return true;          
}
