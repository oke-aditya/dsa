...
// hich is a vector of vectors where each adj[i] represents the list of vertices connected to vertex i. 
// Perform a Breadth First Traversal (BFS) starting from vertex 0, visiting vertices from left to 
