...
class Solution {
 public:
  ...
  int makeConnected(int n, vector<vector<int>> &connections) {
    ...
    // If we have more than one connected component, calculate how many edges
    // are needed To connect `n_connected` components, we need at least
    // `n_connected - 1` edges. So the excess wires will be the total number of
    // wires minus the edges needed to connect all components.
