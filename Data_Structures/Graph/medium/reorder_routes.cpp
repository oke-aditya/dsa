...
// How do we track this out? Take -ve sign for directions that are pointing towards.
// Count of direction pointing outside is niegh > 0
// Trace this on notebook
// 
// 
...
int dfs(vector<vector<int>> &adj, vector<vector<int>> &connections, vector<int> &visited, int source)
{
    int count = 0;
    visited[source] = 1;
