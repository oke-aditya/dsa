...
// https://www.geeksforgeeks.org/problem                                    s/implementing-dijkstra-set-1-adjacency-matrix/1
...
// update the distance
// Dijisktra is used when we have weighted graph, it could be directed / undirected.
// adjacency list contains each node with pair, denoting weight and adjacent neighbor
