...
// In stack push back (2 * ele - min). This would indicate there is some anamoly in stack.
// While popping if we find such anamoly (element > min). Then we will re compute back
// the element.
