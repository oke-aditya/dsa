...
//  That left element already knows which is the maximum number it will
//  encounter
...
// Keep removing all the numbers (Since we need to find the number larger than
// it. IF found then great if not then it has result 0).
