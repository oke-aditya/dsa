...
// arrays inT[] and preT[]. 2) Find inorder and preorder traversals of S, store
// them in two auxiliary arrays inS[] and preS[]. 3) If inS[] is a subarray of
// inT[] and preS[] is a subarray preT[], then S is a subtree of T. Else not. We
// can also use postorder traversal in place of preorder in the above algorithm.
//
//
