...
// single level while maintaining the sorted order.
...
// We can merge them using same logic as in merge sort, by comparing the greater
// elements. We keep this to a temp node and return it. This flattens two lists.
