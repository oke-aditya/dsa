...
// One extra thing we need to consider only those pairs which have one element from ar1[] and other from ar2[],
...
//     4) Print the result.
    ...
    cout<<endl<<"Element in array1:  "<<left_ele;
    cout<<endl<<"Element in array2: "<<right_ele;
    cout<<endl<<"Closest sum = "<<(left_ele + right_ele);
}
