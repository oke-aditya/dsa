...
// Again iterate over hashmap and print numbers that occur more than floor(n /
// 3) times.
//
...
// Maintain two variables, and two counters. Both the variables keep track of
// counts. Iterate oever the array and increase counter if either number
// matches. Decrase both the counts if numbers don't match.
