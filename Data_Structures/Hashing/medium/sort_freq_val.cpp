...
// 5 and 2 are then tied in terms of frequency (both 3 times) but 5 has higher
// value so it comes second.

// Solution 1 (Naive): -
// Maintain an ordered map, each containing number and frequency.
// Traverse throught the map. find number with max frequency and add it to
// result. Delete that key form map, repeat.

// Solution 2 : -
// Implement custom sorting based on frequency.
// we can dump the map into a vector of pairs, and implement the custom sort
// there.
