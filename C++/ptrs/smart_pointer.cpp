...
// In above example
// Once the function ends this ‘p’ is deleted because p is a local variable to the function
// but a new rectangle that is allocated inside heap that will not be deallocated
// We will soon be occupying the heap memory space, through infinte loops.
// We need to explicitly delete the pointer.
