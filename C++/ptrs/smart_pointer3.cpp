...
// points to the resource and decremented when the destructor of the object is
// called.
//
// Reference Counting: It is a technique
// of storing the number of references, pointers or handles
// to a resource such as an object, block of memory, disk space or other
// resources.
...
// this propose. when all shared_ptr’s pointing to resource goes out of scope
