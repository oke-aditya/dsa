...
// called Local Class A local class type name can only be used in the enclosing
// function.
...
void fun2() {
  class Test2 {
    void display() { cout << "Hello from here"; }
  };
...
// Non-static variables of the enclosing function are not accessible inside
// local classes
