...
// It is not mandatory for the derived class to override (or re-define
...
class Base
{
    public:
        virtual void print()
        {
            cout<< "Print of base class is called"<<endl;
        }

        void show()
        {
            cout<<"Show base class is called"<<endl;
        }
};
...
class Derived : public Base
{
    public:
        void print()
        {
            cout<<"Print of Derived class is called"<<endl;
        }

        void show()
        {
            cout<<"Show of derived class is called"<<endl;
        }
};
